...
translations_tuple = (
    (
        ...
        (
            "ja_JP",
            "Project-Id-Version: MMD Tools 4.5.14 (0)\n",
    ...
    (
        ("*", "Additional Unallowed Characters in Bone Name"),
        (("bpy.types.MMDToolsAddonPreferences.additional_unallowed_chars_bone",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Characters that are not allowed in bone names. Each character in this string will be treated as unallowed"),
        (("bpy.types.MMDToolsAddonPreferences.additional_unallowed_chars_bone",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Additional Unallowed Characters in Model Name"),
        (("bpy.types.MMDToolsAddonPreferences.additional_unallowed_chars_model",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Characters that are not allowed in model names. Each character in this string will be treated as unallowed"),
        (("bpy.types.MMDToolsAddonPreferences.additional_unallowed_chars_model",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Additional Unallowed Characters in Morph Name"),
        (("bpy.types.MMDToolsAddonPreferences.additional_unallowed_chars_morph",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Characters that are not allowed in morph names. Each character in this string will be treated as unallowed"),
        (("bpy.types.MMDToolsAddonPreferences.additional_unallowed_chars_morph",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Additional Unallowed Characters in Texture Name"),
        (("bpy.types.MMDToolsAddonPreferences.additional_unallowed_chars_texture",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Characters that are not allowed in texture names. Each character in this string will be treated as unallowed"),
        (("bpy.types.MMDToolsAddonPreferences.additional_unallowed_chars_texture",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        (("bpy.types.MMDToolsAddonPreferences.replacement_char",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Character used to replace unallowed characters. Leave empty to remove them instead"),
        (("bpy.types.MMDToolsAddonPreferences.replacement_char",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        (("bpy.types.MMDToolsAddonPreferences.shared_toon_folder",), ()),
        ("ja_JP", "トゥーンテクスチャのパス. 通常は MikuMikuDance の Data ディレクトリ内にあります", (False, ())),
        ("zh_HANS", "卡通纹理路径. 通常是 MikuMikuDance 安装路径下的 Data 目录", (False, ())),
    ),
    (
        ("*", "MMD PMX/PMD Model"),
    ...
    (
        ...
        ("ja_JP", "モデルにメッシュを取付", (False, ())),
        ("zh_HANS", "将网格附加至模型", (False, ())),
    ),
    (
        ("*", "Finds existing meshes and attaches them to the selected MMD model"),
        (("bpy.types.MMD_TOOLS_OT_attach_meshes",), ()),
        ("ja_JP", "既存のメッシュを探し、選択中のMMDモデルに取り付けます", (False, ())),
        ("zh_HANS", "寻找现存的网格, 并将其附加到选中的 MMD 模型上", (False, ())),
    ),
    (
        ("Operator", "Batch Convert To Vertex Morph"),
        (("bpy.types.MMD_TOOLS_OT_batch_convert_bone_morph_to_vertex_morph", "bpy.types.MMD_TOOLS_OT_batch_convert_group_morph_to_vertex_morph"), ()),
        ("ja_JP", "頂点モーフに一括変換", (False, ())),
    ...
    (
        ...
        ("ja_JP", "全てのボーンモーフを頂点モーフに変換する", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ...
        ("ja_JP", "全ての頂点モーフを含むグループモーフを頂点モーフに変換する", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        ("ja_JP", "選択中のボーンの軸制限を無効にします", (False, ())),
        ("zh_HANS", "为选中的骨骼禁用MMD固定坐标轴", (False, ())),
    ),
    (
        ("*", "Load"),
        (("bpy.types.MMD_TOOLS_OT_bone_fixed_axis_setup.type:'LOAD'", "bpy.types.MMD_TOOLS_OT_bone_local_axes_setup.type:'LOAD'"), ()),
        ("ja_JP", "読み込み", (False, ())),
        ("zh_HANS", "加载", (False, ())),
    ),
    (
        ...
        ("ja_JP", "選択中のボーンのMMD軸制限をY軸または回転可能な軸方向から読み込み/有効化する", (False, ())),
        ("zh_HANS", "以Y轴或唯一的可旋转轴为选中的骨骼加载或启用MMD固定坐标轴", (False, ())),
    ),
    (
        ("*", "Align bone axes to MMD fixed axis of each bone"),
        (("bpy.types.MMD_TOOLS_OT_bone_fixed_axis_setup.type:'APPLY'",), ()),
        ("ja_JP", "ボーン軸を軸制限の方向に揃える", (False, ())),
    ...
    (
        ...
        ("ja_JP", "選択中のボーンのローカル軸を無効にします", (False, ())),
    ...
    (
        ...
        ("ja_JP", "選択中のボーンのMMDローカル軸をボーン軸方向から読み込み/有効化する", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_build_rig",), ()),
        ("ja_JP", "選択中のオブジェクトの物理をBlender用に変換します\n\n警告: クラッシュやパフォーマンス低下の恐れがあります. 安定性や物理演算の精度が高いMMDBridgeを推奨します", (False, ())),
    ...
    (
        ...
        ("ja_JP", "剛体間の衝突マージン. 0で各形状の規定値が使用されます", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_build_rig.non_collision_distance_scale",), ()),
        ("ja_JP", "物理を設定する際に追加で非衝突コンストレイントを生成する距離のスケール", (False, ())),
        ("zh_HANS", "装配物理时创建的额外非碰撞约束的距离比例", (False, ())),
    ),
    (
        ("Operator", "Change MMD IK Loop Factor"),
        (("bpy.types.MMD_TOOLS_OT_change_mmd_ik_loop_factor", "extensions/blender_org/mmd_tools/panels/prop_object.py:34", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:168"), ()),
    ...
    (
        ...
        ("ja_JP", "Blender内での全ボーンのIK反復の係数", (False, ())),
        ("zh_HANS", "Blender 中所有骨骼的逆向运动学迭代数乘数", (False, ())),
    ),
    (
        ("*", "MMD IK Loop Factor"),
        (("bpy.types.MMD_TOOLS_OT_change_mmd_ik_loop_factor.mmd_ik_loop_factor", "bpy.types.MMDRoot.ik_loop_factor"), ()),
        ("ja_JP", "MMD IK反復係数", (False, ())),
        ("zh_HANS", "MMD IK循环系数", (False, ())),
    ),
    (
        ("*", "Scaling factor of MMD IK loop"),
        (("bpy.types.MMD_TOOLS_OT_change_mmd_ik_loop_factor.mmd_ik_loop_factor", "bpy.types.MMD_TOOLS_OT_import_model.ik_loop_factor", "bpy.types.MMDRoot.ik_loop_factor"), ()),
        ("ja_JP", "IK反復の倍率", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_clean_invalid_bone_id_references",), ()),
        ("ja_JP", "現在のMMDモデルから存在しないボーン番号を探し、全て取り除きます. ボーン削除後に整合性を維持するのに便利です", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("Operator", "Clean Rig"),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_clean_rig",), ()),
        ("ja_JP", "選択中のオブジェクトの物理オブジェクトを削除し、既定のMMDの状態に戻します", (False, ())),
        ("zh_HANS", "删除选中物体的临时物理物体并将物理复原为 MMD 默认状态", (False, ())),
    ),
    (
        ("Operator", "Clean Shape Keys"),
        (("bpy.types.MMD_TOOLS_OT_clean_shape_keys", "extensions/blender_org/mmd_tools/menus.py:83"), ()),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_bone_morph_to_vertex_morph",), ()),
        ("ja_JP", "ボーン変形を適用し、ボーンモーフを頂点モーフに変換します.\n対応する頂点モーフがすでにある場合は、それを更新します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("Operator", "Convert Blender Materials"),
        (("bpy.types.MMD_TOOLS_OT_convert_bsdf_materials",), ()),
        ("ja_JP", "Blenderマテリアルを変換", (False, ())),
        ("zh_HANS", "转换 Blender 材质", (False, ())),
    ),
    (
        ("*", "Convert materials of selected objects."),
        (("bpy.types.MMD_TOOLS_OT_convert_bsdf_materials", "bpy.types.MMD_TOOLS_OT_convert_materials"), ()),
        ("ja_JP", "選択中のオブジェクトのマテリアルを変換します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_group_morph_to_vertex_morph",), ()),
        ("ja_JP", "グループモーフ内の頂点モーフのみをマージし、グループモーフを頂点モーフに変換します.\n対応する頂点モーフがすでにある場合は、それを更新します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("Operator", "Convert Materials"),
        (("bpy.types.MMD_TOOLS_OT_convert_materials",), ()),
        ("ja_JP", "マテリアルを変換", (False, ())),
        ("zh_HANS", "转换材质", (False, ())),
    ),
    (
        ("*", "Clean Nodes"),
        (("bpy.types.MMD_TOOLS_OT_convert_materials.clean_nodes", "bpy.types.MMD_TOOLS_OT_convert_materials_for_cycles.clean_nodes"), ()),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_materials.clean_nodes", "bpy.types.MMD_TOOLS_OT_convert_materials_for_cycles.clean_nodes"), ()),
        ("ja_JP", "余分なノードを削除します. ノードを保持するには無効にしてください", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_materials.use_principled", "bpy.types.MMD_TOOLS_OT_convert_materials_for_cycles.use_principled"), ()),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_materials.use_principled", "bpy.types.MMD_TOOLS_OT_convert_materials_for_cycles.use_principled"), ()),
        ("ja_JP", "MMDシェーダーノードをプリンシプルBSDFに変換します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_to_mmd_camera.camera_source",), ()),
        ("ja_JP", "アニメーションをベイクするカメラを選択 (カメラターゲットは選択またはDoFオブジェクト)", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_to_mmd_camera.min_distance",), ()),
        ("ja_JP", "アニメーションベイク時のカメラターゲットの最小距離", (False, ())),
    ...
    (
        ...
        ("ja_JP", "カメラ初期化時のスケール", (False, ())),
        ("zh_HANS", "初始化相机的比例系数", (False, ())),
    ),
    (
        ("Operator", "Convert to MMD Light"),
        (("bpy.types.MMD_TOOLS_OT_convert_to_mmd_light",), ()),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_to_mmd_light",), ()),
        ("ja_JP", "MMD用にライトリグを作成します", (False, ())),
        ("zh_HANS", "创建 MMD 光源绑定", (False, ())),
    ),
    (
        ("*", "Scaling factor for initializing the light"),
        (("bpy.types.MMD_TOOLS_OT_convert_to_mmd_light.scale",), ()),
        ("ja_JP", "ライト初期化時のスケール", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_to_mmd_model",), ()),
        ("ja_JP", "選択中のアーマチュアとメッシュをMMDモデルに変換します (実験的)", (False, ())),
    ...
    (
        ...
        ("ja_JP", 'ミラー (属性 "mirror_color" が存在する場合)', (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_to_mmd_model.edge_alpha_min",), ()),
        ("ja_JP", "MMDトゥーンエッジ色の透明度の最小値", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_convert_to_mmd_model.edge_threshold",), ()),
        ("ja_JP", "freestyleラインカラーの透明度がこの値未満の場合、MMDトゥーンエッジは有効になりません", (False, ())),
        ("zh_HANS", "若 Freestyle 线条颜色小于此值，则MMD卡通边缘不会启用", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_create_mmd_model_root_object",), ()),
        ("ja_JP", "基本的なアーマチュアを含むMMDルートオブジェクトを作成します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_create_mmd_model_root_object.name_e", "bpy.types.MMDRoot.name_e"), ()),
        ("ja_JP", "MMDモデルの英語名", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_display_item_find",), ()),
        ("ja_JP", "選択中のボーンやモーフの表示項目を検索します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_display_item_find.type:'BONE'",), ()),
        ("ja_JP", "選択中のボーンの表示項目を検索します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_display_item_find.type:'MORPH'",), ()),
        ("ja_JP", "選択中のモーフの表示項目を検索します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_display_item_frame_add",), ()),
        ("ja_JP", "表示項目フレームをリストに追加します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_display_item_frame_move",), ()),
        ("ja_JP", "選択中の表示項目フレームを上下に移動します", (False, ())),
        ("zh_HANS", "将活动的表示枠上移或下移", (False, ())),
    ),
    (
        ("*", "Move type"),
        (("bpy.types.MMD_TOOLS_OT_display_item_frame_move.type", "bpy.types.MMD_TOOLS_OT_display_item_move.type", "bpy.types.MMD_TOOLS_OT_morph_move.type", "bpy.types.MMD_TOOLS_OT_object_move.type"), ()),
        ("ja_JP", "移動タイプ", (False, ())),
        ("zh_HANS", "移动类型", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_display_item_frame_remove",), ()),
        ("ja_JP", "選択中の表示項目フレームをリストから削除します", (False, ())),
    ...
    (
        ...
        ("ja_JP", "アンロックするフレームのインデックス", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_display_item_move",), ()),
        ("ja_JP", "選択中の表示項目を上下に移動します. エクスポートするPMXファイルのモーフ順序も変更されます", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        ("ja_JP", "全ての項目とフレームを削除し、初期状態に戻します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_export_pmx",), ()),
        ("ja_JP", "選択中のMMDモデルをPMXファイルにエクスポートします (.pmx)", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_export_pmx.disable_specular",), ()),
        ("ja_JP", "全ての反射マップテクスチャを無効化します. 一部のMMEシェーダーでは必須です", (False, ())),
    ...
    (
        ...
        ("ja_JP", "頂点カラーを追加UV2として書き出します. PMXファイルに頂点カラーを保存するのに使えます. 有効にすると、モデルに既にある追加UV2データはエクスポート時に省かれます", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Filepath used for exporting the file"),
        (("bpy.types.MMD_TOOLS_OT_export_pmx.filepath", "bpy.types.MMD_TOOLS_OT_export_vmd.filepath", "bpy.types.MMD_TOOLS_OT_export_vpd.filepath"), ()),
        ("ja_JP", "ファイルを書き出すのに使われるパス", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Fix Bone Order"),
        (("bpy.types.MMD_TOOLS_OT_export_pmx.fix_bone_order", "bpy.types.MMD_TOOLS_OT_import_model.fix_bone_order"), ()),
    ...
    (
        ...
        ("ja_JP", "エクスポート前に自動でボーン順序を直します. MMD互換性のためにボーンが正しい順序になっていることを保証します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "IK Angle Limits"),
    ...
    (
        ...
        (
            "ja_JP",
            "存在する全てのIK角度制限を次の優先順位で書き出します: mmd_ik_limit_override -> Blender IK制限 -> その他. mmd_ik_limit_overrideで軸が無効になっていてもBlender IK制限がその軸で有効になっている場合はBlenderの制限も書き出されます. 既存のワークフローでの互換性を維持します",
            (False, ()),
        ),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        (
            "ja_JP",
            "エクスポート時に完全に全てのIK角度制限を無視します. 角度制限はmmd_ik_limit_override、Blender IK制限、または その他のコンストレイント設定にかかわらず一切PMXファイルに書き込まれません. MMD v9.19以降の軸制限のみ使う際に便利です",
            (False, ()),
        ),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        (
            "ja_JP",
            "mmd_ik_limit_overrideのみをIK制限に使用します. mmd_ik_limit_overrideがある場合: mmd_ik_limit_overrideで有効になっている軸のみ制限が書き出され、無効になっている軸は制限されません (Blender IK制限は無視). mmd_ik_limit_overrideがない場合: Blender IK制限で代替されます. mmd_ik_limit_overrideが完全に軸制限の書き出しを '上書き' するため、ボーンごとの細かい制御ができます",
            (False, ()),
        ),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_export_pmx.normal_handling",), ()),
        ("ja_JP", "エクスポート時に法線をどうするか選びます. 頂点、辺を分離して分かれた法線を維持するので、頂点や辺の数、メッシュのトポロジーに影響がでます", (False, ())),
        ("zh_HANS", "选择导出时如何处理法线。这会影响顶点数量、边数量以及网格拓扑，通过拆分顶点和边来保留拆边法线。", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_export_pmx.normal_handling:'PRESERVE_ALL_NORMALS'",), ()),
        ("ja_JP", "既存の法線に変更を加えず書き出します. 頂点数が大幅に増えたり、合理的な範囲に収まっているか確かめてください. 過度に分離されたモデルを書き出さないようにしてください", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Smooth All Normals"),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_export_pmx.normal_handling:'SMOOTH_ALL_NORMALS'",), ()),
        ("ja_JP", "シャープを無視し、強制的に全ての法線をスムーズにします. 完全にスムーズシェーディングがなされ、頂点数が最も少なくなります. 使用時はモデルがスムーズすぎないか確かめてください", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_export_pmx.overwrite_bone_morphs_from_action_pose",), ()),
        ("ja_JP", "エクスポート前にボーンモーフをアクションポーズから上書きします", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_export_pmx.sort_materials",), ()),
        ("ja_JP", "アルファブレンド用にマテリアルをソートします. 警告: モデル内に透明なメッシュがあると動作しません. 例: 照れメッシュ", (False, ())),
        ("zh_HANS", "将材质排序以用于 Alpha 混合 警告: 若透明材质的网格在同一模型中则无效 例如腮红的网格", (False, ())),
    ),
    (
        ("*", "Sort Vertices"),
    ...
    (
        ...
        ("ja_JP", "Blender内部の頂点順序を使用します", (False, ())),
    ...
    (
        ...
        ("ja_JP", '頂点グループ "mmd_vertex_order" のカスタム頂点ウェイトを使用します', (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_export_translation_csv",), ()),
        ("ja_JP", "外部翻訳用にCSVをエクスポートします", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        ("ja_JP", "VMDファイルをエクスポート (.vmd)", (False, ())),
    ...
    (
        ...
        (
            "ja_JP",
            "選択中のオブジェクトのモーションデータをVMDファイルにエクスポートします (.vmd)\n選択中のオブジェクトによって挙動が異なります:\n- ルート (モデルの下にある十字): アーマチュアとモーフ両方のアニメーションをエクスポートします\n- モデル: モーフアニメーションのみエクスポートします\n- アーマチュア: アーマチュアアニメーションのみエクスポートします",
            (False, ()),
        ),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_export_vmd.preserve_curves",), ()),
        ("ja_JP", "キーフレームを追加しアニメーションカーブを正確に保存します. BlenderのベジエハンドルはVMDフォーマットより柔軟です. キーフレームを追加し、元の曲線を近似しないと複雑なハンドル設定が失われてしまいます", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Scaling factor for exporting the motion"),
        (("bpy.types.MMD_TOOLS_OT_export_vmd.scale",), ()),
        ("ja_JP", "モーションエクスポート時のスケール", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_export_vmd.use_frame_range",), ()),
        ("ja_JP", "コンテクストシーンのフレーム範囲にあるフレームのみ書き出します", (False, ())),
        ("zh_HANS", "仅导出当前上下文场景中帧范围中的帧", (False, ())),
    ),
    (
        ("*", "Treat Current Pose as Rest Pose"),
        (("bpy.types.MMD_TOOLS_OT_export_vmd.use_pose_mode", "bpy.types.MMD_TOOLS_OT_export_vpd.use_pose_mode", "bpy.types.MMD_TOOLS_OT_import_vmd.use_pose_mode", "bpy.types.MMD_TOOLS_OT_import_vpd.use_pose_mode"), ()),
    ...
    (
        ...
        ("ja_JP", "モデルをポーズしてTポーズやAポーズといった、異なる初期ポーズ用にモーションデータをエクスポートできます", (False, ())),
        ("zh_HANS", "可设置模型的姿态以将动作数据导出至不同的基础姿态，如T字姿态或A字姿态", (False, ())),
    ),
    (
        ("Operator", "Export VPD File (.vpd)"),
        (("bpy.types.MMD_TOOLS_OT_export_vpd",), ()),
        ("ja_JP", "VPDファイルをエクスポート (.vpd)", (False, ())),
    ...
    (
        ...
        (
            "ja_JP",
            "選択中のリグのアクションポーズをVPDファイルにエクスポートします (.vpd)\n選択中のオブジェクトによって挙動が異なります:\n- ルート (モデルの下にある十字): アーマチュアとモーフ両方のポーズをエクスポートします\n- モデル: モーフのみエクスポートします\n- アーマチュア: アーマチュアポーズのみエクスポートします",
            (False, ()),
        ),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        ("ja_JP", "モデルをポーズしてTポーズやAポーズといった、異なる初期ポーズ用にポーズデータをエクスポートできます", (False, ())),
        ("zh_HANS", "可设置模型的姿态以将姿态数据导出至不同的基础姿态，如T字姿态或A字姿态", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_fix_texture_issues",), ()),
        ("ja_JP", "テクスチャの名前やパス問題を自動で修正します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("Operator", "Flip Pose"),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_flip_pose",), ()),
        ("ja_JP", "選択したボーンのポーズをX軸の反対側にある一致するボーンに適用します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        ("ja_JP", "モデルをインポート (.pmd, .pmx)", (False, ())),
        ("zh_HANS", "导入模型文件 (.pmd, .pmx)", (False, ())),
    ),
    (
        ("*", "Import model file(s) (.pmd, .pmx)"),
        (("bpy.types.MMD_TOOLS_OT_import_model",), ()),
        ("ja_JP", "モデルをインポートします (.pmd, .pmx)", (False, ())),
        ("zh_HANS", "导入模型文件 (.pmd, .pmx)", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_import_model.apply_bone_fixed_axis",), ()),
        ("ja_JP", "ボーンの軸制限を適用しBlenderに適応させます", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_import_model.clean_model",), ()),
        ("ja_JP", "未使用の頂点と重複/不正面を削除します", (False, ())),
        ("zh_HANS", "移除未使用的顶点和重复的或无效的面", (False, ())),
    ),
    (
        ("*", "Rename Bones To English"),
        (("bpy.types.MMD_TOOLS_OT_import_model.dictionary", "bpy.types.MMD_TOOLS_OT_import_vmd.dictionary", "bpy.types.MMD_TOOLS_OT_import_vpd.dictionary"), ()),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_import_model.dictionary", "bpy.types.MMD_TOOLS_OT_import_vmd.dictionary", "bpy.types.MMD_TOOLS_OT_import_vpd.dictionary"), ()),
        ("ja_JP", "選択された辞書を使ってボーン名を日本語から英語に翻訳します", (False, ())),
    ...
    (
        ...
        ("ja_JP", "インポート後に自動でボーン順序を直します. MMD互換性のためにボーンが正しい順序になっていることを保証します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Fix IK Links"),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_import_model.fix_ik_links",), ()),
        ("ja_JP", "IKリンクを修正しBlenderに適応させます. ボーンチェーン内のボーンのヘッドとテールを合わせます", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_import_model.rename_bones", "bpy.types.MMD_TOOLS_OT_import_vmd.rename_bones", "bpy.types.MMD_TOOLS_OT_import_vpd.rename_bones"), ()),
    ...
    (
        ("*", "Types"),
        (("bpy.types.MMD_TOOLS_OT_import_model.types", "bpy.types.MMD_TOOLS_OT_translate_mmd_model.types"), ()),
        ("ja_JP", "タイプ", (False, ())),
        ("zh_HANS", "类型", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_import_model.use_underscore", "bpy.types.MMD_TOOLS_OT_import_vmd.use_underscore", "bpy.types.MMD_TOOLS_OT_import_vpd.use_underscore"), ()),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_import_translation_csv.only_update_english_name",), ()),
        ("ja_JP", "(デフォルトで有効) 英語名 (name_e) のみ更新します. 無効時には変更された名前を全て更新します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("Operator", "Import VMD File (.vmd)"),
        (("bpy.types.MMD_TOOLS_OT_import_vmd",), ()),
        ("ja_JP", "VMDファイルをインポート (.vmd)", (False, ())),
    ...
    (
        ...
        (
            "ja_JP",
            "選択中のオブジェクトにVMDファイルをインポートします (.vmd)\n選択中のオブジェクトによって挙動が異なります:\n- ルート (モデルの下にある十字): アーマチュアとモーフ両方のアニメーションをインポートします\n- モデル: モーフアニメーションのみインポートします\n- アーマチュア: アーマチュアアニメーションのみインポートします",
            (False, ()),
        ),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_import_vmd.bone_mapper:'BLENDER'", "bpy.types.MMD_TOOLS_OT_import_vpd.bone_mapper:'BLENDER'"), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "使用 Blender 骨骼名", (False, ())),
    ),
    (
        ("*", "Use japanese name of MMD bone"),
        (("bpy.types.MMD_TOOLS_OT_import_vmd.bone_mapper:'PMX'", "bpy.types.MMD_TOOLS_OT_import_vpd.bone_mapper:'PMX'"), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "使用 MMD 骨骼的日语名", (False, ())),
    ),
    (
        ("*", "Renamed bones"),
        (("bpy.types.MMD_TOOLS_OT_import_vmd.bone_mapper:'RENAMED_BONES'", "bpy.types.MMD_TOOLS_OT_import_vpd.bone_mapper:'RENAMED_BONES'"), ()),
    ...
    (
        ("*", "Detect Light Cut"),
        (("bpy.types.MMD_TOOLS_OT_import_vmd.detect_light_changes",), ()),
        ("ja_JP", "", (False, ())),
    ...
    (
        ...
        ("ja_JP", "モデルをポーズしてTポーズやAポーズといった、モーションデータの元のポーズに合わせることができます", (False, ())),
        ("zh_HANS", "可将设置模型的姿态，使其符合动作数据的原始姿态，如T字姿态或A字姿态", (False, ())),
    ),
    (
        ("Operator", "Import VPD File (.vpd)"),
        (("bpy.types.MMD_TOOLS_OT_import_vpd",), ()),
        ("ja_JP", "VPDファイルをインポート (.vpd)", (False, ())),
    ...
    (
        ...
        (
            "ja_JP",
            "選択中のリグのアクションポーズにVPDファイルをインポートします (.vpd)\n選択中のオブジェクトによって挙動が異なります:\n- ルート (モデルの下にある十字): アーマチュアとモーフ両方のポーズをインポートします\n- モデル: モーフのみインポートします\n- アーマチュア: アーマチュアポーズのみインポートします",
            (False, ()),
        ),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        ("ja_JP", "モデルをポーズしてTポーズやAポーズといった、ポーズデータの元のポーズに合わせることができます", (False, ())),
        ("zh_HANS", "可将设置模型的姿态，使其符合姿态数据的原始姿态，如T字姿态或A字姿态", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_join_meshes.sort_shape_keys",), ()),
        ("ja_JP", "頂点モーフ順にシェイプキーを並べ替える", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_joint_add",), ()),
        ("ja_JP", "選択された剛体オブジェクトにジョイントを追加します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_joint_add.limit_linear_upper",), ()),
        ("ja_JP", "移動制限の最大値", (False, ())),
        ("zh_HANS", "平移距离的上限", (False, ())),
    ),
    (
        ("*", "Spring(Angular)"),
        (("bpy.types.MMD_TOOLS_OT_joint_add.spring_angular", "bpy.types.MMDJoint.spring_angular"), ()),
        ("ja_JP", "ばね(角度)", (False, ())),
        ("zh_HANS", "弹簧(棱角)", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_joint_remove",), ()),
        ("ja_JP", "選択中のジョイントを消去する", (False, ())),
        ("zh_HANS", "删除当前选中的关节", (False, ())),
    ),
    (
        ("Operator", "Cleanup Texture"),
        (("bpy.types.MMD_TOOLS_OT_material_cleanup_texture",), ()),
        ("ja_JP", "テクスチャを除去", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Remove unused texture nodes."),
        (("bpy.types.MMD_TOOLS_OT_material_cleanup_texture",), ()),
        ("ja_JP", "未使用のテクスチャノードを削除します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_material_morph_offset_init",), ()),
        ("ja_JP", "全てのオフセットをターゲット値にする", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_merge_materials",), ()),
        ("ja_JP", "選択中のオブジェクトの中で同じテクスチャを使うマテリアルを統合します. テクスチャノードが1つのマテリアルのみ統合します. テクスチャがないマテリアルや複数ある場合は統合されません. まずBlender用に変換してください.", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        (
            "ja_JP",
            "複数のMMDモデルを1つに統合します.\n\n警告: 統合前にモデルの位置合わせをするときは、ルート (モデルの下にある十字) のみを操作してください. メッシュ、アーマチュア、剛体、ジョイントを直接移動させても同時に動きません.\n\n重要: 統合前に組み立て機能は使わないでください. 統合するにはモデル編集前の状態でなくてはいけません",
            (False, ()),
        ),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        (
            "ja_JP",
            "選択中のボーンに基づいてMMDモデルを複数に分離します.\n\n警告: この操作ではメッシュ、アーマチュア、剛体、ジョイントが分離されます. 分離前にモデルを移動するときは、ルート (モデルの下にある十字) のみを操作してください. メッシュ、アーマチュア、剛体、ジョイントを直接移動させても同時に動きません.\n\n重要: 分離前に組み立て機能は使わないでください. 分離するにはモデル編集前の状態でなくてはいけません",
            (False, ()),
        ),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_morph_add",), ()),
        ("ja_JP", "モーフを選択中のモーフリストに追加します", (False, ())),
    ...
    (
        ("*", "Register keyframes for all morphs"),
        (("bpy.types.MMD_TOOLS_OT_morph_register",), ()),
        ("ja_JP", "全てのモーフのキーフレームを登録します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Skip Unchanged"),
        (("bpy.types.MMD_TOOLS_OT_morph_register.skip_unchanged",), ()),
        ("ja_JP", "未変更をスキップ", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Skip registering for unchanged morphs"),
        (("bpy.types.MMD_TOOLS_OT_morph_register.skip_unchanged",), ()),
        ("ja_JP", "未変更のモーフの登録をスキップします", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "How much change is considered unchanged"),
        (("bpy.types.MMD_TOOLS_OT_morph_register.tolerance",), ()),
        ("ja_JP", "どのくらいの変更を未変更とみなすか", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("Operator", "Register All Morphs"),
        (("bpy.types.MMD_TOOLS_OT_morph_register", "bpy.types.MMD_TOOLS_OT_morph_register"), ()),
        ("ja_JP", "全てのモーフを登録", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_morph_slider_setup",), ()),
        ("ja_JP", "選択中のオブジェクトのMMDモーフをBlender用に変換します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_object_move",), ()),
        ("ja_JP", "選択中のオブジェクトを上下に移動します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_recalculate_bone_roll", "extensions/blender_org/mmd_tools/panels/prop_object.py:35"), ()),
    ...
    (
        ...
        ("ja_JP", "この名前を復元する", (False, ())),
        ("zh_HANS", "恢复名称", (False, ())),
    ),
    (
        ("*", "Add Rigid Bodies to selected bones"),
        (("bpy.types.MMD_TOOLS_OT_rigid_body_add",), ()),
        ("ja_JP", "選択したボーンに剛体を追加します", (False, ())),
        ("zh_HANS", "为选中的骨骼添加刚体", (False, ())),
    ),
    (
        ("*", "Collision Group Mask"),
        (("bpy.types.MMD_TOOLS_OT_rigid_body_add.collision_group_mask", "bpy.types.MMD_TOOLS_OT_rigid_body_select.properties:'collision_group_mask'", "bpy.types.MMDRigidBody.collision_group_mask"), ()),
        ("ja_JP", "衝突グループマスク", (False, ())),
        ("zh_HANS", "碰撞组遮罩", (False, ())),
    ),
    (
        ("*", "The groups the object can not collide with"),
        (("bpy.types.MMD_TOOLS_OT_rigid_body_add.collision_group_mask", "bpy.types.MMDRigidBody.collision_group_mask"), ()),
        ("ja_JP", "物体が衝突できないグループ", (False, ())),
        ("zh_HANS", "该物体不能碰撞的碰撞组", (False, ())),
    ),
    (
        ("*", "Collision Group"),
        (("bpy.types.MMD_TOOLS_OT_rigid_body_add.collision_group_number", "bpy.types.MMD_TOOLS_OT_rigid_body_select.properties:'collision_group_number'", "bpy.types.MMDRigidBody.collision_group_number"), ()),
        ("ja_JP", "衝突グループ", (False, ())),
        ("zh_HANS", "碰撞组", (False, ())),
    ),
    (
        ("*", "The collision group of the object"),
        (("bpy.types.MMD_TOOLS_OT_rigid_body_add.collision_group_number", "bpy.types.MMDRigidBody.collision_group_number"), ()),
        ("ja_JP", "物体の衝突グループ", (False, ())),
        ("zh_HANS", "该物体的碰撞组", (False, ())),
    ),
    (
        ("*", "How much the object 'weights' irrespective of gravity"),
        (("bpy.types.MMD_TOOLS_OT_rigid_body_add.mass",), ()),
        ("ja_JP", '重力に関係な物体の "重さ"', (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_rigid_body_add.rigid_type:'0'", "bpy.types.MMDRigidBody.type:'0'"), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "刚体的朝向完全由附加的骨骼确定", (False, ())),
    ),
    (
        ("*", "Attached bone's orientation completely determined by rigid body"),
        (("bpy.types.MMD_TOOLS_OT_rigid_body_add.rigid_type:'1'", "bpy.types.MMDRigidBody.type:'1'"), ()),
        ("ja_JP", "", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_rigid_body_world_update",), ()),
        ("ja_JP", "現在のシーンのオブジェクトに基づいてリジッドボディワールドとリジッドボディコンストレイントを更新します (実験的)", (False, ())),
        ("zh_HANS", "按照当前场景的物体更新刚体世界以及刚体约束的引用 (实验性)", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_sdef_bind",), ()),
        ("ja_JP", "選択中のオブジェクトのSDEFデータをバインドします", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_sdef_bind.mode:'2'",), ()),
        ("ja_JP", "numpyで高速化 (遅くなるケースあり)", (False, ())),
    ...
    (
        ...
        (
            "ja_JP",
            "メッシュをマテリアルで複数オブジェクトに分離します.\n\n警告: 実行後元に戻すことができず、様々な問題の原因になります. 隣接するジオメトリを分離するため、マージしても共有される辺は再接続されません.\n既知の不具合: メッシュの破損、UVマップの問題やその他予期せぬ挙動. バックアップを取り、慎重に扱ってください.",
            (False, ()),
        ),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_set_frame_range",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "将帧区间设置为完整播放动画的最优值, 并将帧率设置为 30.0", (False, ())),
    ),
    (
        ("Operator", "GLSL View"),
    ...
    (
        ("Operator", "Sort Materials"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials", "bpy.types.MMD_TOOLS_OT_sort_materials"), ()),
        ("ja_JP", "マテリアルをソート", (False, ())),
        ("zh_HANS", "排列材质", (False, ())),
    ),
    (
        ("*", "Sort MMD materials in the list"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials",), ()),
        ("ja_JP", "リストのMMDマテリアルを並び替えます", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Sort By"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials.sort_method",), ()),
        ("ja_JP", "並び替え", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_sort_materials.sort_method",), ()),
        ("ja_JP", "並び替えに使用する値", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Blender Name"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials.sort_method:'NAME'",), ()),
        ("ja_JP", "Blender名称", (False, ())),
        ("zh_HANS", "Blender名称", (False, ())),
    ),
    (
        ("*", "Sort by Blender material name"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials.sort_method:'NAME'",), ()),
        ("ja_JP", "Blenderマテリアル名で並び替えます", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Japanese MMD Name"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials.sort_method:'NAME_J'",), ()),
        ("ja_JP", "日本語MMD名称", (False, ())),
        ("zh_HANS", "日文MMD名称", (False, ())),
    ),
    (
        ("*", "Sort by MMD Japanese material name"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials.sort_method:'NAME_J'",), ()),
        ("ja_JP", "MMD日本語マテリアル名で並び替えます", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "English MMD Name"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials.sort_method:'NAME_E'",), ()),
        ("ja_JP", "英語MMD名称", (False, ())),
        ("zh_HANS", "英文MMD名称", (False, ())),
    ),
    (
        ("*", "Sort by MMD English material name"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials.sort_method:'NAME_E'",), ()),
        ("ja_JP", "MMD英語マテリアル名で並び替えます", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Material ID"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials.sort_method:'ID'", "bpy.types.MMDMaterial.material_id", "bpy.types.MaterialMorphData.material_id"), ()),
        ("ja_JP", "マテリアルID", (False, ())),
        ("zh_HANS", "材质ID", (False, ())),
    ),
    (
        ("*", "Sort by MMD material ID"),
        (("bpy.types.MMD_TOOLS_OT_sort_materials.sort_method:'ID'",), ()),
        ("ja_JP", "MMDマテリアルIDで並び替えます", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("Operator", "Toggle Transparent Materials"),
        (("bpy.types.MMD_TOOLS_OT_toggle_transparent_materials",), ()),
        ("ja_JP", "透過材質の表示切替", (False, ())),
        ("zh_HANS", "切换透明材质显示状态", (False, ())),
    ),
    (
        ("*", "Toggle transparent materials by setting alpha to 1.0 or restoring it from mmd_material"),
        (("bpy.types.MMD_TOOLS_OT_toggle_transparent_materials",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Set alpha to 1.0"),
        (("bpy.types.MMD_TOOLS_OT_toggle_transparent_materials.action:'SHOW'",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Restore"),
        (("bpy.types.MMD_TOOLS_OT_toggle_transparent_materials.action:'RESTORE'",), ()),
        ("ja_JP", "復元", (False, ())),
        ("zh_HANS", "恢复", (False, ())),
    ),
    (
        ("*", "Restore alpha from mmd_material"),
        (("bpy.types.MMD_TOOLS_OT_toggle_transparent_materials.action:'RESTORE'",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    ...
    (
        ("*", "Dictionary"),
        (("bpy.types.MMD_TOOLS_OT_translate_mmd_model.dictionary", "bpy.types.MMDTranslation.dictionary"), ()),
        ("ja_JP", "辞書", (False, ())),
        ("zh_HANS", "词典", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_validate_bones",), ()),
        ("ja_JP", "MMDモデルのボーンのエンコード問題や名前長制限を確認します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_validate_morphs",), ()),
        ("ja_JP", "MMDモデルのモーフのエンコード問題や名前長制限、名前の重複を確認します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_validate_textures",), ()),
        ("ja_JP", "MMDモデルのテクスチャの存在しないファイルや矛盾するパス、重複するファイル名を確認します", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("*", "Select category"),
        (("bpy.types.BoneMorph.category", "bpy.types.GroupMorph.category", "bpy.types.MaterialMorph.category", "bpy.types.UVMorph.category", "bpy.types.VertexMorph.category"), ()),
        ("ja_JP", "カテゴリーを選択", (False, ())),
        ("zh_HANS", "选择类别", (False, ())),
    ),
    (
        ("*", "Eye Brow"),
    ...
    (
        ("*", "Morph Data"),
        (("bpy.types.BoneMorph.data", "bpy.types.GroupMorph.data", "bpy.types.MaterialMorph.data", "bpy.types.UVMorph.data"), ()),
        ("ja_JP", "モーフデータ", (False, ())),
        ("zh_HANS", "变形数据", (False, ())),
    ),
    (
    ...
    (
        ...
        ("ja_JP", "アクティブなグループデータ", (False, ())),
        ("zh_HANS", "活动组数据", (False, ())),
    ),
    (
        ("*", "Group Morph Offset"),
        (("bpy.types.GroupMorphOffset",), ()),
        ("ja_JP", "グループモーフオフセット", (False, ())),
        ("zh_HANS", "组变形偏移", (False, ())),
    ),
    (
        ("*", "Morph Type"),
        (("bpy.types.GroupMorphOffset.morph_type", "bpy.types.MMDDisplayItem.morph_type"), ()),
        ("ja_JP", "モーフタイプ", (False, ())),
        ("zh_HANS", "变形类型", (False, ())),
    ),
    (
    ...
    (
        ("*", "Deformation tier"),
        (("bpy.types.MMDBone.transform_order",), ()),
        ("ja_JP", "変形する順番、大きい順に計算されます", (False, ())),
    ...
    (
        ("*", "Ambient color"),
        (("bpy.types.MMDMaterial.ambient_color", "bpy.types.MaterialMorphData.ambient_color"), ()),
        ("ja_JP", "環境色", (False, ())),
        ("zh_HANS", "环境色", (False, ())),
    ),
    (
    ...
    (
        ...
        ("ja_JP", "トゥーンエッジ色", (False, ())),
        ("zh_HANS", "卡通边缘色", (False, ())),
    ),
    (
        ("*", "Edge Weight"),
        (("bpy.types.MMDMaterial.edge_weight", "bpy.types.MaterialMorphData.edge_weight"), ()),
        ("ja_JP", "エッジウェイト", (False, ())),
        ("zh_HANS", "边缘权重", (True, ())),
    ),
    (
    ...
    (
        ("*", "Reflect"),
        (("bpy.types.MMDMaterial.shininess", "bpy.types.MaterialMorphData.shininess", "bpy.types.MaterialMorphData.shininess"), ()),
        ("ja_JP", "反射", (False, ())),
        ("zh_HANS", "反射", (False, ())),
    ),
    (
    ...
    (
        ...
        ("ja_JP", "スフィアマップタイプ", (False, ())),
        ("zh_HANS", "球面纹理类型", (False, ())),
    ),
    (
        ("*", "Choose sphere texture blend type"),
        (("bpy.types.MMDMaterial.sphere_texture_type",), ()),
        ("ja_JP", "スフィアテクスチャのブレンド方法を選ぶ", (False, ())),
    ...
    (
        ("*", "Toon Texture"),
        (("bpy.types.MMDMaterial.toon_texture", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:147"), ()),
    ...
    (
        ...
        (("bpy.types.MMDRoot.show_armature",), ()),
        ("ja_JP", "MMDモデルのアーマチュアを表示します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMDRoot.show_temporary_objects",), ()),
        ("ja_JP", "MMDモデルのテンポラリオブジェクトを全て表示します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMDRoot.use_property_driver",), ()),
        ("ja_JP", "MMDプロパティアニメーション用 (モデル表示とIKオンオフ) にドライバーを設定します", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMDTranslation.batch_operation_script_preset:'TO_BLENDER_LR'",), ()),
        ("ja_JP", "to_blender_lr(name_j)", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMDTranslation.batch_operation_script_preset:'ENGLISH_IF_EMPTY_JAPANESE'",), ()),
        ("ja_JP", "name_e if name_e else name_j", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMDTranslation.batch_operation_script_preset:'JAPANESE_IF_EMPTY_ENGLISH'",), ()),
        ("ja_JP", "name_j if name_j else name_e", (False, ())),
    ...
    (
        ...
        ("ja_JP", "ターゲットマテリアル", (False, ())),
        ("zh_HANS", "目标材质", (False, ())),
    ),
    (
        ("*", "Material Data"),
        (("bpy.types.MaterialMorphData.material_data",), ()),
        ("ja_JP", "マテリアルデータ", (False, ())),
        ("zh_HANS", "材质数据", (False, ())),
    ),
    (
        ("*", "Offset Type"),
        (("bpy.types.MaterialMorphData.offset_type",), ()),
        ("ja_JP", "オフセットタイプ", (False, ())),
        ("zh_HANS", "偏移类型", (False, ())),
    ),
    (
        ("*", "Select offset type"),
        (("bpy.types.MaterialMorphData.offset_type",), ()),
        ("ja_JP", "オフセットタイプを選択", (False, ())),
    ...
    (
        ...
        (("bpy.types.MaterialMorphData.related_mesh",), ()),
        ("ja_JP", "このモーフが属するメッシュの参照を保持する", (False, ())),
    ...
    (
        ("*", "Texture factor"),
        (("bpy.types.MaterialMorphData.texture_factor", "bpy.types.MaterialMorphData.texture_factor"), ()),
        ("ja_JP", "テクスチャ係数", (False, ())),
        ("zh_HANS", "纹理系数", (False, ())),
    ),
    (
    ...
    (
        ...
        (("bpy.types.UVMorph.vertex_group_scale",), ()),
        ("ja_JP", 'データタイプ "頂点グループ" の値の倍率', (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_ROOT_UL_display_items.mmd_name",), ()),
        ("ja_JP", "MMDボーンの日本語または英語名を表示する", (False, ())),
    ...
    (
        ...
        (("bpy.types.MMD_ROOT_UL_display_items.morph_filter",), ()),
        ("ja_JP", "カテゴリーに一致する項目のみ表示する", (False, ())),
        ("zh_HANS", "仅展示符合分类的项目", (False, ())),
    ),
    (
        ("*", "Model Filter"),
        (("bpy.types.MMD_TOOLS_UL_joints.model_filter", "bpy.types.MMD_TOOLS_UL_rigidbodies.model_filter"), ()),
        ("ja_JP", "モデルフィルタ", (False, ())),
        ("zh_HANS", "模型筛选", (False, ())),
    ),
    (
        ...
        (("bpy.types.MMD_TOOLS_UL_joints.model_filter", "bpy.types.MMD_TOOLS_UL_rigidbodies.model_filter"), ()),
        ("ja_JP", "選択中または全てのモデルの項目を表示する", (False, ())),
        ("zh_HANS", "显示选中的模型还是全部模型的项目", (False, ())),
    ),
    (
        ("*", "Active Model"),
        (("bpy.types.MMD_TOOLS_UL_joints.model_filter:'ACTIVE'", "bpy.types.MMD_TOOLS_UL_rigidbodies.model_filter:'ACTIVE'"), ()),
        ("ja_JP", "選択中のモデル", (False, ())),
        ("zh_HANS", "活动的模型", (False, ())),
    ),
    (
        ("*", "All Models"),
        (("bpy.types.MMD_TOOLS_UL_joints.model_filter:'ALL'", "bpy.types.MMD_TOOLS_UL_rigidbodies.model_filter:'ALL'"), ()),
        ("ja_JP", "全てのモデル", (False, ())),
        ("zh_HANS", "全部模型", (False, ())),
    ),
    (
        ("*", "Only show visible items"),
        (("bpy.types.MMD_TOOLS_UL_joints.visible_only", "bpy.types.MMD_TOOLS_UL_rigidbodies.visible_only"), ()),
        ("ja_JP", "可視のみ", (False, ())),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/menus.py:19", "extensions/blender_org/mmd_tools/menus.py:41"), ()),
        ("ja_JP", "MikuMikuDance モーション (.vmd)", (False, ())),
        ("zh_HANS", "MikuMikuDance 动作 (.vmd)", (False, ())),
    ),
    (
        ("Operator", "Vocaloid Pose Data (.vpd)"),
        (("extensions/blender_org/mmd_tools/menus.py:20", "extensions/blender_org/mmd_tools/menus.py:42"), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/fileio.py:394",), ()),
        ("ja_JP", 'MMDモデルを "%s" からインポートしました', (False, ())),
        ("zh_HANS", '已从"%s"导入 MMD 模型', (True, ())),
    ),
    (
        ("*", 'Imported VMD: ""'),
        (("extensions/blender_org/mmd_tools/operators/fileio.py:621",), ()),
        ("ja_JP", 'VMDをインポートしました: "%s"', (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("*", "No file selected"),
        (("extensions/blender_org/mmd_tools/operators/fileio.py:578",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Object '': Merged  materials"),
        (("extensions/blender_org/mmd_tools/operators/material.py:181",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", " transparent materials"),
        (("extensions/blender_org/mmd_tools/operators/material.py:441",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Object '' has no materials"),
        (("extensions/blender_org/mmd_tools/operators/material.py:121",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "No materials to merge in object ''"),
        (("extensions/blender_org/mmd_tools/operators/material.py:147",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Same Texture '': Merged materials [] into ''"),
        (("extensions/blender_org/mmd_tools/operators/material.py:185",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Added  empty texture nodes."),
        (("extensions/blender_org/mmd_tools/operators/material.py:267",), ()),
        ("ja_JP", "空のテクスチャノードを  追加しました", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Removed  texture nodes."),
        (("extensions/blender_org/mmd_tools/operators/material.py:315",), ()),
        ("ja_JP", "テクスチャノードを  削除しました", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Select a MMD model"),
        (("extensions/blender_org/mmd_tools/operators/material.py:416", "extensions/blender_org/mmd_tools/operators/material.py:466", "extensions/blender_org/mmd_tools/operators/misc.py:209", "extensions/blender_org/mmd_tools/operators/misc.py:255"), ()),
        ("ja_JP", "MMDモデルを選択する", (False, ())),
        ("zh_HANS", "选择 MMD 模型", (False, ())),
    ),
    (
        ("*", "Created  toon edge(s)"),
        (("extensions/blender_org/mmd_tools/operators/material.py:477",), ()),
        ("ja_JP", "トゥーンエッジを  作成しました ", (False, ())),
        ("zh_HANS", "已创建  条卡通边缘", (False, ())),
    ),
    (
        ("*", " * Failed to change to Cycles render engine."),
        (("extensions/blender_org/mmd_tools/operators/material.py:50",), ()),
        ("ja_JP", "Cycles に変更できませんでした", (False, ())),
        ("zh_HANS", " * 未能改变至 Cycles 渲染引擎", (False, ())),
    ),
    (
        ("*", "Materials not found"),
        (("extensions/blender_org/mmd_tools/operators/material.py:366", "extensions/blender_org/mmd_tools/operators/material.py:391"), ()),
        ("ja_JP", "マテリアルが見つかりません", (False, ())),
        ("zh_HANS", "找不到材质", (False, ())),
    ),
    (
        ("*", "This operation will break existing f-curve/action."),
        (("extensions/blender_org/mmd_tools/operators/misc.py:316",), ()),
        ("ja_JP", "この操作は既存のFカーブ/アクションを破壊します", (False, ())),
        ("zh_HANS", "这一操作将破坏现有的函数曲线/动作", (False, ())),
    ),
    (
        ("*", "Click [OK] to run the operation."),
        (("extensions/blender_org/mmd_tools/operators/misc.py:317",), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/misc.py:219",), ()),
        ("ja_JP", "このモデルにはメッシュがありません", (False, ())),
        ("zh_HANS", "该模型不具有任何网格", (False, ())),
    ),
    (
        ("*", "Model Armature not found"),
        (("extensions/blender_org/mmd_tools/operators/misc.py:260",), ()),
        ("ja_JP", "モデルのアーマチュアが見つかりません", (False, ())),
        ("zh_HANS", "找不到模型的骨架", (False, ())),
    ),
    (
        ("*", "Active object is not an armature object"),
        (("extensions/blender_org/mmd_tools/operators/model.py:154", "extensions/blender_org/mmd_tools/operators/model.py:185"), ()),
    ...
    (
        ...
        (
            (
                "extensions/blender_org/mmd_tools/operators/model_validation.py:90",
                "extensions/blender_org/mmd_tools/operators/model_validation.py:136",
                "extensions/blender_org/mmd_tools/operators/model_validation.py:202",
                "extensions/blender_org/mmd_tools/operators/model_validation.py:258",
                "extensions/blender_org/mmd_tools/operators/model_validation.py:393",
                "extensions/blender_org/mmd_tools/operators/model_validation.py:445",
                "extensions/blender_org/mmd_tools/operators/model_validation.py:581",
                "extensions/blender_org/mmd_tools/operators/model_validation.py:702",
            ),
            (),
        ),
        ("ja_JP", "", (False, ())),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/model_validation.py:142", "extensions/blender_org/mmd_tools/operators/model_validation.py:451"), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Registered  morphs."),
        (("extensions/blender_org/mmd_tools/operators/morph.py:231",), ()),
        ("ja_JP", "モーフを  件登録しました", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Batch conversion complete: Converted  bone morphs."),
        (("extensions/blender_org/mmd_tools/operators/morph.py:1059",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Successfully converted vertex morphs in group to vertex morph '' and added to facial display frame"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:1203",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Batch conversion complete: Converted  group morphs."),
        (("extensions/blender_org/mmd_tools/operators/morph.py:1250",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "You need to choose a Related Mesh first"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:371", "extensions/blender_org/mmd_tools/operators/morph.py:435"), ()),
        ("ja_JP", "まず関連するメッシュを選んでください", (False, ())),
        ("zh_HANS", "请首先选择关联的网格", (False, ())),
    ),
    (
        ("*", "The model mesh can't be found"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:375", "extensions/blender_org/mmd_tools/operators/morph.py:439"), ()),
        ("ja_JP", "モデルのメッシュが見つかりません", (False, ())),
        ("zh_HANS", "找不到模型的网格", (False, ())),
    ),
    (
        ("*", 'Material "" not found'),
        (("extensions/blender_org/mmd_tools/operators/morph.py:444",), ()),
        ("ja_JP", 'マテリアル "%s" が見つかりません', (True, ())),
        ("zh_HANS", '找不到材质"%s"', (True, ())),
    ),
    (
        ("*", 'Temporary material "" is in use'),
        (("extensions/blender_org/mmd_tools/operators/morph.py:449",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", '临时材质"%s"已占用', (True, ())),
    ),
    (
        ("*", "No active bone morph"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:873",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Successfully converted bone morph '' to vertex morph ''. Created shape keys: "),
        (("extensions/blender_org/mmd_tools/operators/morph.py:1016",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "No active group morph"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:1090",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "The group morph does not contain any vertex morphs to convert"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:1101",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Material not found"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:381",), ()),
        ("ja_JP", "マテリアルが見つかりません", (False, ())),
        ("zh_HANS", "找不到材质", (False, ())),
    ),
    (
        ("*", "Please select a mesh object"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:659",), ()),
        ("ja_JP", "メッシュオブジェクトを選択してください", (False, ())),
        ("zh_HANS", "选择网格物体", (False, ())),
    ),
    (
        ("*", "Invalid uv index: "),
        (("extensions/blender_org/mmd_tools/operators/morph.py:673",), ()),
        ("ja_JP", "無効なUVインデックス: ", (False, ())),
        ("zh_HANS", "无效 UV 索引: ", (False, ())),
    ),
    (
        ("*", "Failed to create a temporary uv layer"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:683",), ()),
        ("ja_JP", "一時UVレイヤーの作成に失敗しました", (False, ())),
        ("zh_HANS", "无法创建临时 UV 层", (False, ())),
    ),
    (
        ("*", ' * UV map "" not found'),
        (("extensions/blender_org/mmd_tools/operators/morph.py:807",), ()),
        ("ja_JP", ' * UVマップ "%s" が見つかりません', (True, ())),
        ("zh_HANS", ' * 找不到 UV 贴图 "%s"', (True, ())),
    ),
    (
        ("*", "Failed to create morph slider system"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:899",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Bone morph '' not found in morph sliders"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:908",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Created shape key '' on mesh ''"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:962",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Error during conversion: "),
        (("extensions/blender_org/mmd_tools/operators/morph.py:1019",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "An unexpected error happened"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:402",), ()),
        ("ja_JP", "予期しないエラーが発生しました", (False, ())),
        ("zh_HANS", "发生了非预期的错误", (False, ())),
    ),
    (
        ("*", "No armature modifier found on mesh ''"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:949",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Base material for  was not found"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:508",), ()),
    ...
    (
        ("*", "Frame jumped to  for physics stability"),
        (("extensions/blender_org/mmd_tools/operators/rigid_body.py:267",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Please select two or more mmd rigid objects"),
        (("extensions/blender_org/mmd_tools/operators/rigid_body.py:473",), ()),
    ...
    (
        ("*", "Filter"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:265",), ()),
        ("ja_JP", "フィルタ", (False, ())),
        ("zh_HANS", "筛选", (False, ())),
    ),
    (
    ...
    (
        ("*", "English"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:277",), ()),
        ("ja_JP", "英語", (False, ())),
        ("zh_HANS", "英文", (False, ())),
    ),
    (
        ("*", "Select the target column for Batch Operations:"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:305",), ()),
        ("ja_JP", "一括操作の対象列を選択:", (False, ())),
        ("zh_HANS", "选择批量操作的目标列:", (False, ())),
    ),
    (
        ("*", "Batch Operation:"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:326",), ()),
        ("ja_JP", "一括操作:", (False, ())),
        ("zh_HANS", "批量操作:", (False, ())),
    ),
    (
        ("*", "Preset"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:334",), ()),
        ("ja_JP", "プリセット", (False, ())),
        ("zh_HANS", "预设", (False, ())),
    ),
    (
        ("Operator", "Execute"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:337",), ()),
        ("ja_JP", "実行", (False, ())),
        ("zh_HANS", "执行", (False, ())),
    ),
    (
    ...
    (
        ("*", "CSV:"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:352",), ()),
        ("ja_JP", "CSV:", (False, ())),
        ("zh_HANS", "CSV:", (False, ())),
    ),
    (
        ("Operator", "Import CSV"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:354",), ()),
        ("ja_JP", "CSVインポート", (False, ())),
        ("zh_HANS", "导入 CSV", (False, ())),
    ),
    (
        ("Operator", "Export CSV"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:355",), ()),
        ("ja_JP", "CSVエクスポート", (False, ())),
        ("zh_HANS", "导出 CSV", (False, ())),
    ),
    (
        ("*", "Exported to "),
        (("extensions/blender_org/mmd_tools/operators/translations.py:443",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Failed to translate  names, see '' in text editor"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:110", "extensions/blender_org/mmd_tools/operators/translations.py:393"), ()),
        ("ja_JP", "名称  の翻訳に失敗しました, テキストエディタで '' を確認してください", (False, ())),
        ("zh_HANS", "未能翻译  个名称，参见文本编辑器中的 ''", (False, ())),
    ),
    (
        ("*", "Root object not found"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:425", "extensions/blender_org/mmd_tools/operators/translations.py:473"), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("*", "Failed to write CSV: "),
        (("extensions/blender_org/mmd_tools/operators/translations.py:440",), ()),
        ("ja_JP", "CSVの書き出しに失敗しました: %s", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Failed to read CSV: "),
        (("extensions/blender_org/mmd_tools/operators/translations.py:538",), ()),
        ("ja_JP", "CSVの読み込みに失敗しました: %s", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Missing required headers in CSV: , "),
        (("extensions/blender_org/mmd_tools/operators/translations.py:488",), ()),
        ("ja_JP", "必須ヘッダーがCSVに存在しません: , ", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Information:"),
        (("extensions/blender_org/mmd_tools/panels/prop_bone.py:45", "extensions/blender_org/mmd_tools/panels/prop_material.py:30"), ()),
        ("ja_JP", "情報:", (False, ())),
        ("zh_HANS", "信息:", (False, ())),
    ),
    (
        ("*", "ID"),
        (("extensions/blender_org/mmd_tools/panels/prop_bone.py:48", "extensions/blender_org/mmd_tools/panels/prop_material.py:33"), ()),
        ("ja_JP", "ID", (False, ())),
        ("zh_HANS", "ID", (False, ())),
    ),
    (
    ...
    (
        ...
        ("ja_JP", "MMD Shadow Bone!", (False, ())),
        ("zh_HANS", "MMD Shadow Bone!", (False, ())),
    ),
    (
        ("Operator", "Load"),
        (("extensions/blender_org/mmd_tools/panels/prop_bone.py:67", "extensions/blender_org/mmd_tools/panels/prop_bone.py:77"), ()),
        ("ja_JP", "読み込む", (False, ())),
        ("zh_HANS", "加载", (False, ())),
    ),
    (
        ...
        (
            (
                ...
                "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:189",
                "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:220",
                "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:159",
            ),
            (),
        ),
        ("ja_JP", "適用", (False, ())),
    ...
    (
        ...
        ("ja_JP", "オフセットはエクスポート時に自動計算されます", (False, ())),
    ...
    (
        ("Operator", "Convert"),
        (("extensions/blender_org/mmd_tools/panels/prop_camera.py:43", "extensions/blender_org/mmd_tools/panels/prop_light.py:35"), ()),
        ("ja_JP", "変換", (False, ())),
        ("zh_HANS", "转换", (False, ())),
    ),
    (
        ("*", "Light Source"),
        (("extensions/blender_org/mmd_tools/panels/prop_light.py:33",), ()),
        ("ja_JP", "光源", (False, ())),
        ("zh_HANS", "光源", (False, ())),
    ),
    (
    ...
    (
        ("*", "X-Axis:"),
        (("extensions/blender_org/mmd_tools/panels/prop_physics.py:117", "extensions/blender_org/mmd_tools/panels/prop_physics.py:133"), ()),
        ("ja_JP", "X軸:", (False, ())),
        ("zh_HANS", "X轴:", (False, ())),
    ),
    (
        ("*", "Y-Axis:"),
        (("extensions/blender_org/mmd_tools/panels/prop_physics.py:118", "extensions/blender_org/mmd_tools/panels/prop_physics.py:134"), ()),
        ("ja_JP", "Y軸:", (False, ())),
        ("zh_HANS", "Y轴:", (False, ())),
    ),
    (
        ("*", "Z-Axis:"),
        (("extensions/blender_org/mmd_tools/panels/prop_physics.py:119", "extensions/blender_org/mmd_tools/panels/prop_physics.py:135"), ()),
        ("ja_JP", "Z軸:", (False, ())),
        ("zh_HANS", "Z轴:", (False, ())),
    ),
    (
    ...
    (
        ("Operator", "Reset"),
        (("extensions/blender_org/mmd_tools/panels/shading.py:27", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:40"), ()),
        ("ja_JP", "リセット", (False, ())),
        ("zh_HANS", "重设", (False, ())),
    ),
    (
        ("*", "Migrating from old vertex group ordering to bone_id system"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:279",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "从旧的顶点组排序迁移至新的骨骼 ID 系统", (False, ())),
    ),
    (
        ("*", "Successfully migrated  bones from vertex groups to bone_id system"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:304",), ()),
        ("ja_JP", "", (False, ())),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:615", "extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:662"), ()),
        ("ja_JP", "ボーン順序を修正", (False, ())),
        ("zh_HANS", "修复骨骼顺序", (False, ())),
    ),
    (
        ("*", "Total Bones: %d"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:661", "extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:661"), ()),
        ("ja_JP", "ボーン合計: %d", (False, ())),
        ("zh_HANS", "骨骼数量: %d", (False, ())),
    ),
    (
        ("*", "Bone ID is invalid (-1). Please click 'Fix Bone Order' button first to assign proper bone IDs."),
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:35", "extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:77"), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Cleaned  invalid bone reference(s)."),
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:165",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Bone order did not converge after 10 iterations"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:201",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Converting layer collections to MMD collections"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:254",), ()),
        ("ja_JP", "", (False, ())),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:328",), ()),
        ("ja_JP", "不正なボーン参照を  件削除しました", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "No invalid bone references were found."),
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:330",), ()),
        ("ja_JP", "不正なボーン参照は見つかりませんでした", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Select a MMD Model"),
        (
            (
                "extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:629",
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:634",), ()),
        ("ja_JP", "選択中のMMDモデルのアーマチュアが見つかりません", (False, ())),
        ("zh_HANS", "找不到选中MMD模型的骨架", (False, ())),
    ),
    (
        ("Operator", "Select"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/display_panel.py:74", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:205"), ()),
        ("ja_JP", "選択", (False, ())),
        ("zh_HANS", "选择", (False, ())),
    ),
    (
        ("Operator", "Bone"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/display_panel.py:72", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:73"), ()),
        ("ja_JP", "ボーン", (False, ())),
        ("zh_HANS", "骨骼", (False, ())),
    ),
    (
        ("Operator", "Morph"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/display_panel.py:73", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:77"), ()),
        ("ja_JP", "モーフ", (False, ())),
        ("zh_HANS", "变形", (False, ())),
    ),
    (
        ...
        (
            (
                ...
                "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:367",
    ...
    (
        ...
        (
            (
                ...
                "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:368",
    ...
    (
        ("Operator", "Delete All"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/display_panel.py:193", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:358"), ()),
        ("ja_JP", "全て削除", (False, ())),
        ("zh_HANS", "删除全部", (False, ())),
    ),
    (
        ("*", "Use the arrows to sort"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/material_sorter.py:48", "extensions/blender_org/mmd_tools/panels/sidebar/meshes_sorter.py:47"), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_debug.py:60",), ()),
        ("ja_JP", "テクスチャを修正", (False, ())),
        ("zh_HANS", "修复贴图", (False, ())),
    ),
    (
        ("Operator", "Fix Bones"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_debug.py:61",), ()),
        ("ja_JP", "ボーンを修正", (False, ())),
        ("zh_HANS", "修复骨骼", (False, ())),
    ),
    (
        ("Operator", "Fix Morphs"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_debug.py:62",), ()),
        ("ja_JP", "モーフを修正", (False, ())),
        ("zh_HANS", "修复变形", (False, ())),
    ),
    (
        ("*", "Run validation to see results"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_debug.py:50",), ()),
        ("ja_JP", "検証後結果が表示されます", (False, ())),
        ("zh_HANS", "运行测试以查看结果", (False, ())),
    ),
    (
        ("*", "... and  more results."),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_debug.py:46",), ()),
        ("ja_JP", "...とさらに  件。", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Check System Console for full log."),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_debug.py:47",), ()),
        ("ja_JP", "完全なログはシステムコンソールを確認してください", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("Operator", "Join"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_production.py:62", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:139"), ()),
        ("ja_JP", "統合", (False, ())),
        ("zh_HANS", "合并", (False, ())),
    ),
    (
    ...
    (
        ("*", "IK Toggle:"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:128",), ()),
        ("ja_JP", "IK切替え:", (False, ())),
        ("zh_HANS", "IK切换:", (False, ())),
    ),
    (
        ("*", "Mesh (Experimental):"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:136",), ()),
        ("ja_JP", "メッシュ (実験的):", (False, ())),
        ("zh_HANS", "网格 (实验性):", (False, ())),
    ),
    (
        ("*", "Material:"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:143",), ()),
        ("ja_JP", "マテリアル:", (False, ())),
        ("zh_HANS", "材质:", (False, ())),
    ),
    (
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:158",), ()),
        ("ja_JP", "MMD用に変換", (False, ())),
        ("zh_HANS", "转换给MMD", (False, ())),
    ),
    (
        ("Operator", "Setup Textures"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:160",), ()),
        ("ja_JP", "テクスチャ構成", (False, ())),
        ("zh_HANS", "设置纹理节点", (False, ())),
    ),
    (
        ("Operator", "Texture Cleanup"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:161",), ()),
        ("ja_JP", "テクスチャ除去", (False, ())),
        ("zh_HANS", "清理纹理节点", (False, ())),
    ),
    (
        ("*", "Misc:"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:165",), ()),
        ("ja_JP", "その他:", (False, ())),
        ("zh_HANS", "杂项:", (False, ())),
    ),
    (
        ("Operator", "(Experimental) Global Translation"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:167",), ()),
        ("ja_JP", "(実験的) 全体翻訳", (False, ())),
        ("zh_HANS", "(实验性) 全局翻译", (False, ())),
    ),
    (
        ("Operator", "Physics"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:85", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:87"), ()),
        ("ja_JP", "物理演算", (False, ())),
        ("zh_HANS", "物理", (False, ())),
    ),
    (
        ("Operator", "Show Transparent Material"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:150",), ()),
        ("ja_JP", "透過材質を表示", (False, ())),
        ("zh_HANS", "显示透明材质", (False, ())),
    ),
    (
        ("Operator", "Edge Preview"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:153",), ()),
        ("ja_JP", "輪郭プレビュー", (False, ())),
        ("zh_HANS", "边缘预览", (False, ())),
    ),
    (
        ("*", "Material Offsets (%d)"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:109", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:109"), ()),
        ("ja_JP", "マテリアルオフセット (%d)", (False, ())),
        ("zh_HANS", "材质偏移 (%d)", (False, ())),
    ),
    (
        ("Operator", "View"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:188", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:216"), ()),
        ("ja_JP", "表示", (False, ())),
        ("zh_HANS", "显示", (False, ())),
    ),
    (
        ...
        (
            (
                "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:190",
                "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:217",
                "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:160",
                "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:134",
            ),
            (),
        ),
        ("ja_JP", "クリア", (False, ())),
    ...
    (
        ("*", "Bone Offsets (%d)"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:196", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:196"), ()),
        ("ja_JP", "ボーンオフセット (%d)", (False, ())),
        ("zh_HANS", "骨骼偏移 (%d)", (False, ())),
    ),
    (
        ("Operator", "Edit"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:219", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:206"), ()),
        ("ja_JP", "編集", (False, ())),
        ("zh_HANS", "编辑", (False, ())),
    ),
    (
        ("*", "Group Offsets (%d)"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:240", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:240"), ()),
        ("ja_JP", "グループオフセット (%d)", (False, ())),
        ("zh_HANS", "群组偏移 (%d)", (False, ())),
    ),
    (
        ("*", "Morph Settings"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:67",), ()),
        ("ja_JP", "モーフ設定", (False, ())),
        ("zh_HANS", "变形设置", (False, ())),
    ),
    (
        ("*", "Not found"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:104",), ()),
        ("ja_JP", "見つかりませんでした", (False, ())),
        ("zh_HANS", "未找到", (False, ())),
    ),
    (
        ("*", "This is not a valid base material"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:122",), ()),
        ("ja_JP", "これは有効なベースマテリアルではありません", (False, ())),
        ("zh_HANS", "不是有效的基础材质", (False, ())),
    ),
    (
        ("*", "Armature not found"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:184",), ()),
        ("ja_JP", "アーマチュアが見つかりません", (False, ())),
        ("zh_HANS", "找不到骨架", (False, ())),
    ),
    (
        ("Operator", "Update"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:207",), ()),
        ("ja_JP", "更新", (False, ())),
        ("zh_HANS", "更新", (False, ())),
    ),
    (
    ...
    (
        ("*", "UV Offsets (%d)"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:230", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:230"), ()),
        ("ja_JP", "UVオフセット (%d)", (False, ())),
        ("zh_HANS", "UV偏移 (%d)", (False, ())),
    ),
    (
        ("Operator", "Bind morphs to .placeholder"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:360",), ()),
        ("ja_JP", "モーフを.placeholderへバインド", (False, ())),
        ("zh_HANS", "将变形绑定到.placeholder", (False, ())),
    ),
    (
        ("Operator", "Unbind morphs from .placeholder"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:361",), ()),
        ("ja_JP", "モーフを.placeholderからバインド解除", (False, ())),
        ("zh_HANS", "解绑变形与.placeholder", (False, ())),
    ),
    (
        ("*", "This offset affects all materials"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:131",), ()),
    ...
    (
        ("Operator", "Import"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/scene_setup.py:29", "extensions/blender_org/mmd_tools/panels/sidebar/scene_setup.py:34", "extensions/blender_org/mmd_tools/panels/sidebar/scene_setup.py:39"), ()),
        ("ja_JP", "インポート", (False, ())),
        ("zh_HANS", "导入", (False, ())),
    ),
    (
        ("Operator", "Export"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/scene_setup.py:30", "extensions/blender_org/mmd_tools/panels/sidebar/scene_setup.py:35", "extensions/blender_org/mmd_tools/panels/sidebar/scene_setup.py:40"), ()),
        ("ja_JP", "エクスポート", (False, ())),
        ("zh_HANS", "导出", (False, ())),
    ),
    (
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/preferences.py:189",), ()),
        ("ja_JP", "既定のオペレータープリセット:", (False, ())),
        ("zh_HANS", "默认操作项预设:", (False, ())),
    ),
    (
        ("*", "PMX Import"),
        (("extensions/blender_org/mmd_tools/preferences.py:190",), ()),
        ("ja_JP", "PMXインポート", (False, ())),
        ("zh_HANS", "PMX 导入", (False, ())),
    ),
    (
        ("*", "PMX Export"),
        (("extensions/blender_org/mmd_tools/preferences.py:191",), ()),
        ("ja_JP", "PMXエクスポート", (False, ())),
        ("zh_HANS", "PMX 导出", (False, ())),
    ),
    (
        ("*", "VMD Import"),
        (("extensions/blender_org/mmd_tools/preferences.py:192",), ()),
        ("ja_JP", "VMDインポート", (False, ())),
        ("zh_HANS", "VMD 导入", (False, ())),
    ),
    (
        ("*", "VMD Export"),
        (("extensions/blender_org/mmd_tools/preferences.py:193",), ()),
        ("ja_JP", "VMDエクスポート", (False, ())),
        ("zh_HANS", "VMD 导出", (False, ())),
    ),
    (
        ("*", "VPD Import"),
        (("extensions/blender_org/mmd_tools/preferences.py:194",), ()),
        ("ja_JP", "VPDインポート", (False, ())),
        ("zh_HANS", "VPD 导入", (False, ())),
    ),
    (
        ("*", "VPD Export"),
        (("extensions/blender_org/mmd_tools/preferences.py:195",), ()),
        ("ja_JP", "VPDエクスポート", (False, ())),
        ("zh_HANS", "VPD 导出", (False, ())),
    ),
    (
        ("*", "Additional Unallowed Characters (Model Debug):"),
        (("extensions/blender_org/mmd_tools/preferences.py:198",), ()),
        ("ja_JP", "追加の禁止文字(モデルデバッグ):", (False, ())),
        ("zh_HANS", "额外的禁止字符(模型调试):", (False, ())),
    ),
    (
        ("*", "Model Name"),
        (("extensions/blender_org/mmd_tools/preferences.py:199",), ()),
        ("ja_JP", "モデル名", (False, ())),
        ("zh_HANS", "模型名称", (False, ())),
    ),
    (
        ("*", "Texture Filename"),
        (("extensions/blender_org/mmd_tools/preferences.py:200",), ()),
        ("ja_JP", "テクスチャファイル名", (False, ())),
        ("zh_HANS", "贴图文件名", (False, ())),
    ),
    (
        ("*", "Bone Name"),
        (("extensions/blender_org/mmd_tools/preferences.py:201",), ()),
        ("ja_JP", "ボーン名", (False, ())),
        ("zh_HANS", "骨骼名称", (False, ())),
    ),
    (
        ("*", "Morph Name"),
        (("extensions/blender_org/mmd_tools/preferences.py:202",), ()),
        ("ja_JP", "モーフ名", (False, ())),
        ("zh_HANS", "变形名称", (False, ())),
    ),
    (
        ("*", "-> Replaced With"),
        (("extensions/blender_org/mmd_tools/preferences.py:203",), ()),
        ("ja_JP", "-> 置換後", (False, ())),
        ("zh_HANS", "-> 替换为", (False, ())),
    ),
    (
